...
import (
	"exams-api/internal/web/controller/admin_handler"
	"exams-api/internal/web/controller/authorized_handler"
	"exams-api/internal/web/controller/config_handler"
	"exams-api/internal/web/controller/dashboard_handler"
	"exams-api/internal/web/controller/gencode_handler"
	"exams-api/internal/web/controller/index_handler"
	"exams-api/internal/web/controller/install_handler"
	"exams-api/internal/web/controller/tool_handler"
)
